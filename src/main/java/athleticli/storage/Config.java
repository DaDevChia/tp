 ...
 */
public class Config {
<<<<<<< HEAD:src/main/java/athleticli/storage/Config.java
=======
    ...
    public static final int MAX_INPUT_NUMBER_ALLOWED = 1000000;
>>>>>>> master:src/main/java/athleticli/common/Config.java
